...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_1_Pin|LED_2_Pin|LED_3_Pin|CLK_Pin
                          |DATA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LATCH_Pin|LED_4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_1_Pin LED_2_Pin LED_3_Pin CLK_Pin
                           DATA_Pin */
  GPIO_InitStruct.Pin = LED_1_Pin|LED_2_Pin|LED_3_Pin|CLK_Pin
                          |DATA_Pin;
  ...
  /*Configure GPIO pins : LATCH_Pin LED_4_Pin */
  GPIO_InitStruct.Pin = LATCH_Pin|LED_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
